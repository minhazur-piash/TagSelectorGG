...
open class TagView: UIButton {
    ...
    @IBInspectable open var removeButtonOvalSize: CGFloat = 12 {
        didSet {
            removeButton.ovalSize = removeButtonOvalSize
            updateRightInsets()
        }
    }
    
    @IBInspectable open var removeButtonOvalColor: UIColor = UIColor.darkGray {
        didSet {
            removeButton.ovalColor = removeButtonOvalColor
            updateRightInsets()
        }
    }
