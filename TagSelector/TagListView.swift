...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var removeButtonOvalSize: CGFloat = 12 {
        didSet {
            for tagView in tagViews {
                tagView.removeButtonOvalSize = removeButtonOvalSize
            }
            rearrangeViews()
        }
    }
    
    @IBInspectable open dynamic var removeButtonOvalColor: UIColor = UIColor.darkGray {
        didSet {
            for tagView in tagViews {
                tagView.removeButtonOvalColor = removeButtonOvalColor
            }
            rearrangeViews()
        }
    }
